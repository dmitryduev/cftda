...
class StoriesPageGalleryImage(Orderable):
    page = ParentalKey(StoriesPage, on_delete=models.CASCADE, related_name='gallery_images')
...
class StoriesTagIndexPage(Page):

    def get_context(self, request):

        # Filter by tag
        tag = request.GET.get('tag')
        pages = StoriesPage.objects.filter(tags__name=tag)
